...
#define QX_STR_CANNOT_INSTANTIATE_ABSTRACT_CLASS "qx::QxFactory<T> ---> cannot instantiate abstract class '{}'"
...
public:
    ...
    {
        QX_AUTO_REGISTER_REPOSITORY(T, sKey);
    }
    virtual ~QxFactory()
    {}
...
private:
    ...
    struct qxCreateInstance
    {
        static inline qx::any create(bool bRawPointer)
        {
            if (bRawPointer)
            {
                T* p = new T(); return qx::any(p);
            }; std::shared_ptr<T> ptr = std::make_shared<T>(); return qx::any(ptr);
        }
    ...
    struct qxCreateInstance<true, bIsIxPersistable, bIsIxService, bIsIxParameter, bIsQObject, dummy>
    {
        static inline qx::any create(bool bRawPointer)
        {
            ...
            xwarn(QX_STR_CANNOT_INSTANTIATE_ABSTRACT_CLASS, qx::trait::get_class_name<T>::get()); 
            return qx::any();
        }
        static inline void* createNudePtr()
        {
    ...
    struct qxCreateInstance<false, true, false, false, bIsQObject, dummy>
    {
        ...
        static inline void* createNudePtr()
        {
            return static_cast<qx::IxPersistable*>(new T());
        }
    };
    ...
    struct qxCreateInstance<false, false, true, false, bIsQObject, dummy>
    {
        ...
        static inline void* createNudePtr()
        {
            return static_cast<qx::service::IxService*>(new T());
        }
    };
    ...
    struct qxCreateInstance<false, false, false, true, bIsQObject, dummy>
    {
        ...
        static inline void* createNudePtr()
        {
            return static_cast<qx::service::IxParameter*>(new T());
        }
    };
#endif // _QX_ENABLE_QT_NETWORK
