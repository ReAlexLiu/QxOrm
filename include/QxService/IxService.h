...
public:
    ...
    {
        return (isValid() && (m_pOutputParameter.get() != NULL));
    }

    virtual void registerClass() const
    {
        xwarn("need to override 'registerClass()' method"); 
        qAssert(false);
    }
