...
#define QX_REGISTER_CLASS_NAME_SEP_INF QStringLiteral("<")
#define QX_REGISTER_CLASS_NAME_SEP_SUP QStringLiteral(">")
#define QX_REGISTER_CLASS_NAME_SEP_NXT QStringLiteral(", ")

#define QX_REGISTER_CLASS_NAME_SEP_INF_XML_TAG QStringLiteral("-")
#define QX_REGISTER_CLASS_NAME_SEP_SUP_XML_TAG QStringLiteral("-")
#define QX_REGISTER_CLASS_NAME_SEP_NXT_XML_TAG QStringLiteral("_")
...
{ \
   ...
   QString tmp = QLatin1String(get_class_name::get()); \
...
struct get_class_name
{
   ...
   static inline const char * get()
   {
      ...
      xwarn("Unable to define correct class name : '{}' => use macro 'QX_REGISTER_CLASS_NAME()' or 'QX_REGISTER_CLASS_NAME_TEMPLATE_X()'", result.c_str());
      return result.c_str();
   }
