...
struct get_sql_type
{
    ...
    static inline const char* get()
    {
        return (std::is_same<T, type_sql>::value ? qx::trait::detail::get_sql_type<type_sql>::get() : qx::trait::get_sql_type<type_sql>::get());
    }
};
...
struct get_sql_type< boost::optional<T> >
{
    static inline const char* get()
    {
        return qx::trait::get_sql_type<T>::get();
    }
};
...
struct get_sql_type< std::pair<T1, T2> >
{
    ...
    {
        static std::string s;
        s = qx::trait::get_sql_type<T1>::get();
        s += "|";
        s += qx::trait::get_sql_type<T2>::get();
        return s.c_str();
    }
};
...
struct get_sql_type< boost::tuple<T1, T2, T3> >
{
    static inline const char* get()
    {
        ...
        s += qx::trait::get_sql_type<T2>::get();
        s += "|";
        s += qx::trait::get_sql_type<T3>::get();
        return s.c_str();
    }
};
...
struct get_sql_type< boost::tuple<T1, T2, T3, T4> >
{
    static inline const char* get()
    {
        ...
        s += qx::trait::get_sql_type<T3>::get();
        s += "|";
        s += qx::trait::get_sql_type<T4>::get();
        return s.c_str();
    }
};
...
struct get_sql_type< boost::tuple<T1, T2, T3, T4, T5> >
{
    static inline const char* get()
    {
        ...
        s += qx::trait::get_sql_type<T4>::get();
        s += "|";
        s += qx::trait::get_sql_type<T5>::get();
        return s.c_str();
    }
};
...
struct get_sql_type< boost::tuple<T1, T2, T3, T4, T5, T6> >
{
    static inline const char* get()
    {
        ...
        s += qx::trait::get_sql_type<T5>::get();
        s += "|";
        s += qx::trait::get_sql_type<T6>::get();
        return s.c_str(); }
};
...
struct get_sql_type< boost::tuple<T1, T2, T3, T4, T5, T6, T7> >
{
    static inline const char* get()
    {
        ...
        s += qx::trait::get_sql_type<T6>::get();
        s += "|";
        s += qx::trait::get_sql_type<T7>::get();
        return s.c_str();
    }
};
...
struct get_sql_type< boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8> >
{
    static inline const char* get()
    {
        ...
        s += qx::trait::get_sql_type<T7>::get();
        s += "|";
        s += qx::trait::get_sql_type<T8>::get();
        return s.c_str();
    }
};
...
struct get_sql_type< boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> >
{
    static inline const char* get()
    {
        ...
        s += qx::trait::get_sql_type<T8>::get();
        s += "|";
        s += qx::trait::get_sql_type<T9>::get();
        return s.c_str();
    }
};
