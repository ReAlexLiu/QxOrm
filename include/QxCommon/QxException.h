...
public:
    ...
    exception(long code, const QString& desc) : std::exception(), m_code(code), m_desc(desc)
    {
        updateWhat();
    }
...
private:
    ...
    void updateWhat()
    {
        m_what = (QStringLiteral("%1^%2").arg(m_code).arg(m_desc));
    }
