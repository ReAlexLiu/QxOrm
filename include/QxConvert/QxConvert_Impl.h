...
#define QX_STR_CVT_QDATE_FORMAT        QStringLiteral("yyyyMMdd")
#define QX_STR_CVT_QTIME_FORMAT        QStringLiteral("hhmmsszzz")
#define QX_STR_CVT_QDATETIME_FORMAT    QStringLiteral("yyyyMMddhhmmsszzz")
...
struct QxConvertHelper_ToString
{
    ...
    {
        qAssertMsg(false, "template must be specialized"); 
...
struct QxConvertHelper_FromJson
{
    ...
    {
        qAssertMsg(false, "template must be specialized");
        Q_UNUSED(j); Q_UNUSED(t); Q_UNUSED(format);
        return qx_bool();
    }
};
...
struct QxConvertHelper_ToString<T, qx::cvt::detail::helper::QxConvertHelper_Generic>
{
    ...
    {
        Q_UNUSED(t); Q_UNUSED(format); Q_UNUSED(index); Q_UNUSED(ctx);
        // If a compilation error occurred here : you have to specialize template 'qx::cvt::detail::QxConvert_ToString< MyType >'
        static_assert(qx_need_to_specialize_template_convert_to_string_from_string, "qx_need_to_specialize_template_convert_to_string_from_string");
        return QString();
    }
...
struct QxConvertHelper_FromString<T, qx::cvt::detail::helper::QxConvertHelper_Generic>
{
    ...
    {
        Q_UNUSED(s); Q_UNUSED(t); Q_UNUSED(format); Q_UNUSED(index); Q_UNUSED(ctx);
        // If a compilation error occurred here : you have to specialize template 'qx::cvt::detail::QxConvert_FromString< MyType >'
        static_assert(qx_need_to_specialize_template_convert_to_string_from_string, "qx_need_to_specialize_template_convert_to_string_from_string");
        return qx_bool(true);
    }
...
private:
    ...
    struct cvtQVariant
    {
        static inline qx_bool fromVariant(const QVariant& v, T& t, const QString& format, int index, qx::cvt::context::ctx_type ctx)
        {
            return qx::cvt::from_string(v.toString(), t, format, index, ctx);
        };
    };
    ...
    struct cvtQVariant<true, dummy>
    {
        static inline qx_bool fromVariant(const QVariant& v, T& t, const QString& format, int index, qx::cvt::context::ctx_type ctx)
        {
            Q_UNUSED(format); Q_UNUSED(index); Q_UNUSED(ctx); t = v.value<T>(); 
            return qx_bool(true);
        };
    };
