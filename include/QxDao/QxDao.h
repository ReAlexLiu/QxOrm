...
template <class T> struct QxDao_Count_WithRelation;
...
{ return qx::dao::detail::QxDao_FetchById_WithRelation<T>::fetchById(QStringLiteral("*"), t, pDatabase); }
...
{ return qx::dao::detail::QxDao_FetchAll_WithRelation<T>::fetchAll(relation, QStringLiteral(""), t, pDatabase); }
...
{ return qx::dao::detail::QxDao_FetchAll_WithRelation<T>::fetchAll(QStringLiteral("*"), QStringLiteral(""), t, pDatabase); }
...
{ return qx::dao::detail::QxDao_FetchAll_WithRelation<T>::fetchAll(QStringLiteral("*"), query, t, pDatabase); }
...
{ return qx::dao::detail::QxDao_Insert_WithRelation<T>::insert(QStringLiteral("*"), t, pDatabase); }
...
{ return qx::dao::detail::QxDao_Update_WithRelation<T>::update(relation, QStringLiteral(""), t, pDatabase); }
...
{ return qx::dao::detail::QxDao_Update_WithRelation<T>::update(QStringLiteral("*"), QStringLiteral(""), t, pDatabase); }
...
{ return qx::dao::detail::QxDao_Update_WithRelation<T>::update(QStringLiteral("*"), query, t, pDatabase); }
...
{ return qx::dao::detail::QxDao_Save_WithRelation<T>::save(QStringLiteral("*"), t, pDatabase); }
