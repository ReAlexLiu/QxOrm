...
{ QSqlError err = qx::dao::detail::QxDao_FetchById_WithRelation<T>::fetchById(QStringLiteral("*"), t, pDatabase); if (err.isValid()) { throw qx::dao::sql_error(err); } }
...
{ QSqlError err = qx::dao::detail::QxDao_FetchAll_WithRelation<T>::fetchAll(relation, QStringLiteral(""), t, pDatabase); if (err.isValid()) { throw qx::dao::sql_error(err); } }
...
{ QSqlError err = qx::dao::detail::QxDao_FetchAll_WithRelation<T>::fetchAll(QStringLiteral("*"), QStringLiteral(""), t, pDatabase); if (err.isValid()) { throw qx::dao::sql_error(err); } }
...
{ QSqlError err = qx::dao::detail::QxDao_FetchAll_WithRelation<T>::fetchAll(QStringLiteral("*"), query, t, pDatabase); if (err.isValid()) { throw qx::dao::sql_error(err); } }
...
{ QSqlError err = qx::dao::detail::QxDao_Insert_WithRelation<T>::insert(QStringLiteral("*"), t, pDatabase); if (err.isValid()) { throw qx::dao::sql_error(err); } }

/*!
 * \ingroup QxDao
 * \brief Update an element and its relationships (or a list of elements + relationships) into database
 * \param relation List of relationships keys to be updated in others tables of database : use QStringLiteral("|") separator to put many relationships keys into this parameter
...
{ QSqlError err = qx::dao::detail::QxDao_Update_WithRelation<T>::update(relation, QStringLiteral(""), t, pDatabase); if (err.isValid()) { throw qx::dao::sql_error(err); } }
...
{ QSqlError err = qx::dao::detail::QxDao_Update_WithRelation<T>::update(QStringLiteral("*"), QStringLiteral(""), t, pDatabase); if (err.isValid()) { throw qx::dao::sql_error(err); } }
...
{ QSqlError err = qx::dao::detail::QxDao_Update_WithRelation<T>::update(QStringLiteral("*"), query, t, pDatabase); if (err.isValid()) { throw qx::dao::sql_error(err); } }
 ...
 * \param relation List of relationships keys to be inserted or updated in others tables of database : use QStringLiteral("|") separator to put many relationships keys into this parameter
 * \param t Element (or list of elements) to be inserted (if no exist) or updated (if already exist) into database
 * \param pDatabase Connection to database (you can manage your own connection pool for example, you can also define a transaction, etc.); if NULL, a valid connection for the current thread is provided by qx::QxSqlDatabase singleton class (optional parameter)
 * \return Throw a <i>qx::dao::sql_error</i> exception when a SQL error occurred
 *
...
{ QSqlError err = qx::dao::detail::QxDao_Save_WithRelation<T>::save(QStringLiteral("*"), t, pDatabase); if (err.isValid()) { throw qx::dao::sql_error(err); } }
