...
#define QX_FUNCTION_ERR_NUMBER_PARAMS              QStringLiteral("Incorrect parameters count")
#define QX_FUNCTION_ERR_INVALID_PARAM              QStringLiteral("Invalid parameter at position 'XXX'")
...
#define QX_FUNCTION_ERR_INVALID_MEMBER_FCT         QStringLiteral("Invalid member function")
...
#define QX_FUNCTION_ERR_INVALID_INVOKE_CALL        QStringLiteral("Invalid 'invoke()' call")
#define QX_FUNCTION_ERR_UNKNOWN_ERROR              QStringLiteral("Unknown error calling function")
