...
private:
    ...
    QxBoostSerializeRegisterHelperX() : QxSingleton<QxBoostSerializeRegisterHelperX>(QStringLiteral("qx::QxBoostSerializeRegisterHelperX"))
    {}
...
private:
    ...
    inline void private_helper(Archive& ar) const
    {
        ...
        _foreach(IxBoostSerializeRegisterHelper * p, m_colHelperX)
        {
            p->helper(ar);
        }
        bDone = true;
