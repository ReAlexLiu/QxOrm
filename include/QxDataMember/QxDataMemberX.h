...
protected:
    ...
    QxDataMemberX() : IxDataMemberX(), QxSingleton< QxDataMemberX<T> >(QStringLiteral("qx::QxDataMemberX_%1").arg(QLatin1String(qx::trait::get_class_name<T>::get_xml_tag())))
    {}
...
private:
    ...
    inline IxDataMemberX* getBaseClass_Helper() const
    {
        return QxDataMemberX<type_base_class>::getSingleton();
    }
