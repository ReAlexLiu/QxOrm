...
struct QxDao_Save_Generic
{
    ...
    {
        qx::dao::detail::QxDao_Helper<T> dao(t, pDatabase, QStringLiteral("save"), new qx::QxSqlQueryBuilder_Update<T>());
        if (!dao.isValid())
        {
            return dao.error();
        }
...
struct QxDao_Save_Container
{
    ...
    static QSqlError save(T& t, QSqlDatabase* pDatabase)
    {
        ...
        qx::dao::detail::QxDao_Helper_Container<T> dao(t, pDatabase, QStringLiteral("save"), new qx::QxSqlQueryBuilder_Update<type_item>());
        if (!dao.isValid())
        {
            return dao.error();
        }
