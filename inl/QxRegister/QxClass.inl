...
void QxClass<T>::init()
{
   ...
   this->setKey(QLatin1String(qx::trait::get_class_name<T>::get()));
   this->setDaoStrategy(QxClass<typename QxClass<T>::type_base_class>::getSingleton()->getDaoStrategy());
   this->setName(QLatin1String(qx::trait::get_class_name<T>::get_xml_tag()));
   this->updateClassX();
   beforeRegisterClass();
}
...
QxClass<qx::trait::no_base_class_defined>::QxClass() : IxClass(), QxSingleton< QxClass<qx::trait::no_base_class_defined> >(QStringLiteral("qx::QxClass_no_base_class_defined")) { setName(QStringLiteral("qx::trait::no_base_class_defined")); setFinalClass(true); }

template <> QX_GCC_WORKAROUND_TEMPLATE_SPEC_INLINE
QxClass<QObject>::QxClass() : IxClass(), QxSingleton< QxClass<QObject> >(QStringLiteral("qx::QxClass_QObject")) { setKey(QStringLiteral("QObject")); setName(QStringLiteral("QObject")); setFinalClass(true); }
