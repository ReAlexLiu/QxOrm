...
{ Q_UNUSED(t); Q_UNUSED(format); Q_UNUSED(index); Q_UNUSED(ctx); return QStringLiteral(""); } };
...
{ Q_UNUSED(index); Q_UNUSED(ctx); return t.toString(format.isEmpty() ? QX_STR_CVT_QDATE_FORMAT : format); } };
...
{ Q_UNUSED(index); Q_UNUSED(ctx); return t.toString(format.isEmpty() ? QX_STR_CVT_QTIME_FORMAT : format); } };
...
{ Q_UNUSED(index); Q_UNUSED(ctx); return t.toString(format.isEmpty() ? QX_STR_CVT_QDATETIME_FORMAT : format); } };
...
{ Q_UNUSED(format); Q_UNUSED(index); Q_UNUSED(ctx); return QLatin1Literal(t); } };
...
struct QxConvert_ToString< QVariant >
{
   static inline QString toString(const QVariant & t, const QString & format, int index, qx::cvt::context::ctx_type ctx)
   {
      ...
      {
         QString type = QStringLiteral("%1").arg(static_cast<int>(t.type()), 6, 10, QLatin1Char('0'));
         QString val = QStringLiteral("$$JSON$$") + type + QStringLiteral("$$");
...
{ Q_UNUSED(format); Q_UNUSED(index); Q_UNUSED(ctx); return (t ? QStringLiteral("1") : QStringLiteral("0")); } };
...
{ Q_UNUSED(format); Q_UNUSED(index); Q_UNUSED(ctx); return QString(QLatin1Char(t)); } };
...
{ Q_UNUSED(index); Q_UNUSED(ctx); return (format.isEmpty() ? QString::number(t) : QString().asprintf(qPrintable(format), t)); } };
...
struct QxConvert_ToString< QJsonValue >
{
   static inline QString toString(const QJsonValue & t, const QString & format, int index, qx::cvt::context::ctx_type ctx)
   {
      ...
      if (! format.isEmpty()) { jsonFormat = ((format == QStringLiteral("indented")) ? QJsonDocument::Indented : jsonFormat); }
