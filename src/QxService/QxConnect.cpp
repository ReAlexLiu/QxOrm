...
struct QxConnect::QxConnectImpl
{
    ...
    QxConnectImpl() : QX_CONSTRUCT_QX_SERVICE_CONNECT()
    {
        m_uiEncryptKey = QX_SERVICE_DEFAULT_ENCRYPT_KEY; ignoreAllSSLErrors();
    }
    ~QxConnectImpl()
    {
        ;
...
QxConnect::QxConnect() : qx::QxSingleton<QxConnect>(QStringLiteral("qx::service::QxConnect")), m_pImpl(new QxConnectImpl())
{}
