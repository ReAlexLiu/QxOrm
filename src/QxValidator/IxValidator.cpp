...
IxValidator::IxValidator(IxValidator::validator_type type) : QxPropertyBag(), m_type(type), m_pDataMember(NULL)
{
    initDefaultMessage();
}
...
IxValidator::validator_type IxValidator::getType() const
{
    return m_type;
}

QString IxValidator::getMessage() const
{
    return m_message;
}

QString IxValidator::getGroup() const
{
    return m_group;
}
...
QVariantList IxValidator::getConstraints() const
{
    return m_Constraints;
}

IxDataMember* IxValidator::getDataMember() const
{
    return m_pDataMember;
}

void IxValidator::setMessage(const QString& s)
{
    m_message = s;
}

void IxValidator::setGroup(const QString& s)
{
    m_group = s;
}
...
{
    m_Constraints.clear(); m_Constraints.append(v);
}
...
void IxValidator::setDataMember(IxDataMember* p)
{
    m_pDataMember = p;
}
...
{
    QString s = v.toString();
    QString pattern = QStringLiteral("\\b[A-Z0-9._%+-]+@[A-Z0-9.-]+\\.[A-Z]{2,4}\\b");
