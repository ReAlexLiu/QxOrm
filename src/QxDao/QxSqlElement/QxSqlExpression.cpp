...
QString QxSqlExpression::toString() const
{
   ...
   switch (m_type)
   {
      case _where:               sReturn = QStringLiteral("WHERE");   break;
      case _and:                 sReturn = QStringLiteral("AND");     break;
      case _or:                  sReturn = QStringLiteral("OR");      break;
      case _open_parenthesis:    sReturn = QStringLiteral("(");       break;
      case _close_parenthesis:   sReturn = QStringLiteral(")");       break;
