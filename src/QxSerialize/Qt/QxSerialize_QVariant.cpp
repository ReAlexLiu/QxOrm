...
inline void qx_save(Archive& ar, const QVariant& t, const unsigned int file_version)
{
    ...
    {
        QBrush qbrush; qbrush = t.value<QBrush>(); ar << boost::serialization::make_nvp(sTag, qbrush);
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Color)
    {
        QColor qcolor; qcolor = t.value<QColor>(); ar << boost::serialization::make_nvp(sTag, qcolor);
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Font)
    {
        QFont qfont; qfont = t.value<QFont>(); ar << boost::serialization::make_nvp(sTag, qfont);
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Image)
    {
        QImage qimage; qimage = t.value<QImage>(); ar << boost::serialization::make_nvp(sTag, qimage);
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Pixmap)
    {
        QPixmap qpixmap; qpixmap = t.value<QPixmap>(); ar << boost::serialization::make_nvp(sTag, qpixmap);
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Region)
    {
        QRegion qregion; qregion = t.value<QRegion>(); ar << boost::serialization::make_nvp(sTag, qregion);
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    ...
    {
        QString sUserType(QStringLiteral("unknown variant serialize type"));
        qx::QxClassX::type_fct_save_qvariant_usertype fct;
        fct = qx::QxClassX::getFctSaveQVariantUserType();
        if (fct)
        {
            sUserType = fct(t, iType, file_version);
        }
...
inline void qx_load(Archive& ar, QVariant& t, const unsigned int file_version)
{
    ...
    {
        QBrush qbrush; ar >> boost::serialization::make_nvp(sTag, qbrush); t = qbrush;
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Color)
    {
        QColor qcolor; ar >> boost::serialization::make_nvp(sTag, qcolor); t = qcolor;
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Font)
    {
        QFont qfont; ar >> boost::serialization::make_nvp(sTag, qfont); t = qfont;
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Image)
    {
        QImage qimage; ar >> boost::serialization::make_nvp(sTag, qimage); t = qimage;
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Pixmap)
    {
        QPixmap qpixmap; ar >> boost::serialization::make_nvp(sTag, qpixmap); t = qpixmap;
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
    else if (iType == QVariant::Region)
    {
        QRegion qregion; ar >> boost::serialization::make_nvp(sTag, qregion); t = qregion;
    } /* if you crash on this line, please check in your main() function if you have created a QApplication and not a QCoreApplication ! */
#endif // _QX_ENABLE_QT_GUI
    else if (iType == QVariant::Invalid)
    {
    ...
    else
    {
        ...
        if (fct)
        {
            t = fct(sUserType, iType, file_version);
        }
        else
        {
            t = QVariant();
